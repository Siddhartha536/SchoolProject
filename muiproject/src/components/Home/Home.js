...
function Home() {
  ...
  return  (
      <div>
          <Grid container>
              <Grid xs={12} style={{border:"2px solid red"}}>
              <Grid style={{display:"flex",flexDirection:"row",background:"red"}}>
                  <Grid><School style={{height:"200px",width:"200px"}}/></Grid>
                  <Grid style={{display:"flex",flexDirection:"column",marginLeft:"5%",color:"white",fontWeight:"bold",border:"2px solid red"}}>
                      <Grid style={{fontSize:"30px",marginTop:"30px"}}>
                      Green English Boarding School
                      </Grid>
                      <Grid style={{margin:"80px 30px 0px 0px",border:"2px solid red"}}>
